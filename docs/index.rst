...
| - `Laser_Format <https://malcolmwilliams.github.io/Laser-Writer/code.html#module-Laser_Format>`_ contains all the functions to properly segment and format the message.
